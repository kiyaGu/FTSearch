...
if (
    ...
    let createArticleEntry = (article, ul) => {
    ...
    let setPaginationElements = page => {
    ...
    if (previousPageButton !== null) {
        document.getElementById("previousPage").addEventListener("click", e => {
            let query = document.getElementById("previousPage").getAttribute("href");
